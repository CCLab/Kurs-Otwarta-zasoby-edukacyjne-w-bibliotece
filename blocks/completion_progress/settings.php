...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcolourpicker('block_completion_progress/toImproveRated_colour',
            get_string('toImproveRated_colour_title', 'block_completion_progress'),
            get_string('toImproveRated_colour_descr', 'block_completion_progress'),
            get_string('toImproveRated_colour', 'block_completion_progress'),
            null )
    );
    // fioletowy = praca oddana do sprawdzenia,
    $settings->add(new admin_setting_configcolourpicker('block_completion_progress/toCheck_colour',
            get_string('toCheck_colour_title', 'block_completion_progress'),
            get_string('toCheck_colour_descr', 'block_completion_progress'),
            get_string('toCheck_colour', 'block_completion_progress'),
            null )
    );
    // zielony = praca oceniona i zaliczona,
    $settings->add(new admin_setting_configcolourpicker('block_completion_progress/checkedOk_colour',
            get_string('checkedOk_colour_title', 'block_completion_progress'),
            get_string('checkedOk_colour_descr', 'block_completion_progress'),
            get_string('checkedOk_colour', 'block_completion_progress'),
            null )
    );
    // czerwony = praca oceniona i niezaliczona
    $settings->add(new admin_setting_configcolourpicker('block_completion_progress/checkedNo_colour',
            get_string('checkedNo_colour_title', 'block_completion_progress'),
            get_string('checkedNo_colour_descr', 'block_completion_progress'),
            get_string('checkedNo_colour', 'block_completion_progress'),
            null )
    );
