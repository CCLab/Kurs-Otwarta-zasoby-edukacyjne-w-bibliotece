...
class author extends exporter {
    ...
    public function get_authorlink() {
        ...
        if(is_enrolled($coursecontext, $this->author->get_id())){
        ...
        else
        {
            ...
            $link = $urlfactory->get_author_profile_url($this->author, $COURSE->id);
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        if ($this->canview) {
            ...
            return [
                ...
                'urls' => [
                    'profile' => $authorlink,
                    // wstawienie linku authorlink zamiast linku do profilu ogólnego
