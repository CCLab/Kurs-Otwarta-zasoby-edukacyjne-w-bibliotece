...
$THEME->prescsscallback = 'theme_spoled_get_pre_scss';
$THEME->extrascsscallback = 'theme_spoled_get_extra_scss';
$THEME->scss = function($theme) {
    return theme_spoled_get_main_scss_content($theme);
};
