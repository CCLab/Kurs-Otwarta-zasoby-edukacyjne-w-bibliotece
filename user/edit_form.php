...
class user_edit_form extends moodleform {
    ...
    public function definition () {
        ...
        $fields = ['city','country','timezone','maildisplay',
            'url','icq','skype','aim','yahoo','msn','idnumber','institution',
            'department','phone1','phone2','address',
            'moodle_optional', 'moodle_interests', 'moodle_additional_names'];
        ...
        foreach ($enabledusernamefields as $addname) {
            if ($mform->elementExists($addname)) {
                $mform->removeElement($addname);
            }
        }

        $disabledusernamefields = useredit_get_disabled_name_fields($enabledusernamefields);
        foreach ($disabledusernamefields as $allname) {
            if ($mform->elementExists($allname)) {
                $mform->removeElement($allname);
            }
        }
